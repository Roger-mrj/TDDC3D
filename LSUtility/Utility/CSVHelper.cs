    ...
    public class CSVHelper
    {
        ...
        public static void ExportDataGridToCSV(DataTable dt, string destFile)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    aLine += DelQuota(dt.Rows[i][j].ToString()) + ",";
        ...
        /// <param name="columnIdx">列 索引，如果为-1，则导出所有列</param>
        public static void ExportDataGridToCSV2(DataTable dt, string destFile, int columnIdx)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                {
                    string myStr = DelQuota(dt.Rows[i][columnIdx].ToString());
                    aLine += myStr + ",";
                    //sw.Write(myStr);
                    //sw.Write(",");
                }
