...
{
    public class LS_TysdMDBHelper
    {
        /// <summary>
        /// 默认配置文件MDB路径
        /// </summary>
        public static string m_MDBFilePath = Application.StartupPath + @"\SystemConf\result.mdb";

        public static OleDbConnection myConn = new OleDbConnection();
        
        public static void ConnectionOpen()
        {
            myConn=GetConn(m_MDBFilePath);
        }
