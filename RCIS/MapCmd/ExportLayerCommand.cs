...
namespace RCIS.MapTool
{
    ...
    public sealed class ExportLayerCommand : BaseCommand
    {
        ...
        public ExportLayerCommand()
        {
            ...
            base.m_caption = "导出图层数据...";  //localizable text 
            base.m_message = "This should work in ArcMap/MapControl/PageLayoutControl";  //localizable text
            base.m_toolTip = "导出图层数据...";  //localizable text
        ...
        public override void OnClick()
        {
            ...
            if (pselection == null)
            {
                MessageBox.Show("请选择争取的矢量数据图层，在进行数据导出操作！");
                return;
            }
            ...
            if (frmDataExport.ShowDialog() == DialogResult.OK)
            {
                ...
                //MessageBox.Show("可以输出了：\n" + frmDataExport.ShapefilePath);
                //this.pSelSymLayer//这是选定的图层
