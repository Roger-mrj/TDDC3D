...
namespace RCIS.MapCmd
{
    ...
    /// </summary>
    [Guid("91da7a9e-54dd-407e-a16a-c1c7ec911a3b")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("RCIS.MapCmd.ZoomToLayerCmd")]
    public sealed class ZoomToLayerCmd : BaseCommand
    {
        ...
        public ZoomToLayerCmd()
        {
            ...
            base.m_caption = "缩放到该图层";  //localizable text 
            base.m_message = "This should work in ArcMap/MapControl/PageLayoutControl";  //localizable text
            base.m_toolTip = "缩放到该图层";  //localizable text
        ...
        public override void OnClick()
        {
            ...
            this.m_hookHelper.ActiveView.Extent = thisLyr.AreaOfInterest;
