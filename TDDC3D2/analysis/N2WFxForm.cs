...
{
    public partial class N2WFxForm : Form
    {
        public N2WFxForm()
        {
            InitializeComponent();
        ...
        private void N2WFxForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    while ((pFeature = pCursor.NextFeature()) != null)
                    {
                        ...
                        if (YWCommonHelper.IsNyd(dlbm) && YWCommonHelper.Is2DWlyd(dlbm2))
                        //if (YWCommonHelper.IsNyd(dlbm)  && YWCommonHelper.isWlyd(dlbm2))
                        {
                            //冲击算图斑面积
                            if (currDh == -1)
                            {
