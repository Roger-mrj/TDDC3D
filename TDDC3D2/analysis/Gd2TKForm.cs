...
{
    public partial class Gd2TKForm : Form
    {
        public Gd2TKForm()
        {
            InitializeComponent();
        ...
        private void Gd2TKForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    while ((pFeature = pCursor.NextFeature()) != null)
                    {
                        ...
                        string nyypdl = FeatureHelper.GetFeatureStringValue(pFeature, "NYYPDL");
                        if (oldDlbm.StartsWith("01") && nyypdl.Equals("1203"))
                        {
                            //冲击算图斑面积
                            if (currDh == -1)
                            {
                            ...
                            //记录
                            DataRow[] resultRow = resultDT.Select("BGQDLBM='" + oldDlbm + "' and BGHDLBM='" + nyypdl + "'");
