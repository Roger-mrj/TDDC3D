...
{
    public partial class XzjsydfxForm : Form
    {
        public XzjsydfxForm()
        {
            InitializeComponent();
        ...
        private void XzjsydfxForm_Load(object sender, EventArgs e)
        {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string oldDlbm = FeatureHelper.GetFeatureStringValue(pFeature, "DLBM");
                        string byzDlbm = FeatureHelper.GetFeatureStringValue(pFeature, "NYYPDL");

                        //if ((YWCommonHelper.IsNyd(oldDlbm) || YWCommonHelper.isWlyd(oldDlbm)) && YWCommonHelper.isJsyd(byzDlbm))
                        
                        if ((YWCommonHelper.IsNyd(oldDlbm) || YWCommonHelper.isWlyd(oldDlbm)) && YWCommonHelper.is2DJsyd(byzDlbm))
                        {
                            //冲击算图斑面积
                            if (currDh == -1)
                            {
                            ...
                            //记录
                            DataRow[] resultRow = resultDT.Select("BGQDLBM='" + oldDlbm + "' and BGHDLBM='" + byzDlbm + "'");
