...
{
    public partial class CjdcqSplitDltbOptForm : Form
    {
        public CjdcqSplitDltbOptForm()
        {
            InitializeComponent();
        }
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sys.YWCommonHelper.SplitDltbByCjdcq(xzqClass, dltbClass, wait, (this.currMap as IActiveView).Extent,ref errList);
