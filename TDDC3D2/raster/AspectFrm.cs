...
{
    public partial class AspectFrm : Form
    {
        public AspectFrm()
        {
            InitializeComponent();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pOutRaster = RasterHelper.ProduceAspectData(outputName, outdir, rasterDataset as IGeoDataset, rasterWorkspace);
